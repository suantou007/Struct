...
public interface List<T> {
	...
	/*
	 * Precondition: Struct.List is not full and newElement is not null.
	 * PostCondition:
	 ...
	 * If there is not enough space in the list, throw a Struct.ListException exception.
	 * Struct.ListException is a custom Exception class which you should define it.
	 */
	void remove();
	/*
	 * Precondition: 
	 * Struct.List is not empty.
	 * PostCondition:
	...
	/*
	 * Precondition: 
	 * Struct.List is not empty and newElement is not null.
	 * PostCondition:
	...
	/*
	 * Precondition: 
	 * Struct.List contains at least n + 1 elements.
	 * Postcondition:
